...
export class CShopordersEditPage extends CEntityPage<CShoporder> implements OnInit {
	...
	public async ngOnInit(): Promise<void> {
		try {
			this.appService.setTitle(`${this.thelang.words["shoporders-head"]} - ${this.thelang.words["common-edit"]}`);
			this.x = await this.shoporderRepository.loadOne(parseInt(this.route.snapshot.params["id"]));
