...
@Component({
	selector: 'linktypes-create-page',
	templateUrl: './linktypes.create.page.html',	
	styleUrls: ["../../../../styles/forms.scss"],
	encapsulation: ViewEncapsulation.None,
})
export class CLinktypesCreatePage extends CEntityPage<CLinktype> implements OnInit {		
	...
	public async ngOnInit(): Promise<void> {
		try {			
			this.appService.setTitle(`${this.thelang.words["linktypes-head"]} - ${this.thelang.words["common-create"]}`); 
			this.x = new CLinktype().init();	
			this.appService.monitorLog("[linktypes create] page loaded");
			this.ready = true;
		} catch (err) {
