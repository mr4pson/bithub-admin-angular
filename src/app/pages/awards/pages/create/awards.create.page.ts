...
@Component({
	selector: 'awards-create-page',
	templateUrl: './awards.create.page.html',	
	styleUrls: ["../../../../styles/forms.scss"],
	encapsulation: ViewEncapsulation.None,
})
export class CAwardsCreatePage extends CEntityPage<CAward> implements OnInit {		
	...
	public async ngOnInit(): Promise<void> {
		try {			
			this.appService.setTitle(`${this.thelang.words["awards-head"]} - ${this.thelang.words["common-create"]}`); 
			this.ll = await this.langRepository.loadAll();
			this.x = new CAward().init(this.ll);	
			this.appService.monitorLog("[awards create] page loaded");
			this.ready = true;
		} catch (err) {
