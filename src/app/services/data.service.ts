...
export class CDataService {
    ...
    public linktypesChunk(dto: IGetList): Observable<IResponse<ILinktype[]>> {return this.sendRequest("linktypes/chunk", dto);}
    public linktypesOne(id: number): Observable<IResponse<ILinktype>> {return this.sendRequest(`linktypes/one/${id}`);}
    public linktypesDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`linktypes/delete/${id}`);}
    public linktypesDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("linktypes/delete-bulk", ids);}
    public linktypesCreate(fd: FormData): Observable<IResponse<ILinktype>> {return this.sendRequest("linktypes/create", fd);}
    public linktypesUpdate(fd: FormData): Observable<IResponse<ILinktype>> {return this.sendRequest("linktypes/update", fd);}

    public guidesChunk(dto: IGetList): Observable<IResponse<IGuide[]>> {return this.sendRequest("guides/chunk", dto);}
    public guidesOne(id: number): Observable<IResponse<IGuide>> {return this.sendRequest(`guides/one/${id}`);}
    public guidesDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`guides/delete/${id}`);}
    public guidesDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("guides/delete-bulk", ids);}
    public guidesCreate(fd: FormData): Observable<IResponse<IGuide>> {return this.sendRequest("guides/create", fd);}
    public guidesUpdate(fd: FormData): Observable<IResponse<IGuide>> {return this.sendRequest("guides/update", fd);}
    ...
    public promocodesChunk(dto: IGetList): Observable<IResponse<IPromocode[]>> {return this.sendRequest("promocodes/chunk", dto);}
    public promocodesOne(id: number): Observable<IResponse<IPromocode>> {return this.sendRequest(`promocodes/one/${id}`);}
    public promocodesDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`promocodes/delete/${id}`);}
    public promocodesDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("promocodes/delete-bulk", ids);}
    public promocodesCreate(fd: FormData): Observable<IResponse<IPromocode>> {return this.sendRequest("promocodes/create", fd);}
    public promocodesUpdate(fd: FormData): Observable<IResponse<IPromocode>> {return this.sendRequest("promocodes/update", fd);}

    public inordersChunk(dto: IGetList): Observable<IResponse<IInorder[]>> {return this.sendRequest("inorders/chunk", dto);}
    public inordersOne(id: number): Observable<IResponse<IInorder>> {return this.sendRequest(`inorders/one/${id}`);}
    public inordersDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`inorders/delete/${id}`);}
    public inordersDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("inorders/delete-bulk", ids);}

    public outordersChunk(dto: IGetList): Observable<IResponse<IOutorder[]>> {return this.sendRequest("outorders/chunk", dto);}
    public outordersOne(id: number): Observable<IResponse<IOutorder>> {return this.sendRequest(`outorders/one/${id}`);}
    public outordersDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`outorders/delete/${id}`);}
    public outordersDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("outorders/delete-bulk", ids);}

    public refordersChunk(dto: IGetList): Observable<IResponse<IReforder[]>> {return this.sendRequest("reforders/chunk", dto);}
    public refordersOne(id: number): Observable<IResponse<IReforder>> {return this.sendRequest(`reforders/one/${id}`);}
    public refordersDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`reforders/delete/${id}`);}
    public refordersDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("reforders/delete-bulk", ids);}

    public proposalsChunk(dto: IGetList): Observable<IResponse<IProposal[]>> {return this.sendRequest("proposals/chunk", dto);}
    public proposalsOne(id: number): Observable<IResponse<IProposal>> {return this.sendRequest(`proposals/one/${id}`);}
    public proposalsDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`proposals/delete/${id}`);}
    public proposalsDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("proposals/delete-bulk", ids);}
    public proposalsUpdate(fd: FormData): Observable<IResponse<IProposal>> {return this.sendRequest("proposals/update", fd);}

    public artcatsChunk(dto: IGetList): Observable<IResponse<IArtcat[]>> {return this.sendRequest("artcats/chunk", dto);}
    public artcatsOne(id: number): Observable<IResponse<IArtcat>> {return this.sendRequest(`artcats/one/${id}`);}
    public artcatsDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`artcats/delete/${id}`);}
    public artcatsDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("artcats/delete-bulk", ids);}
    public artcatsCreate(fd: FormData): Observable<IResponse<IArtcat>> {return this.sendRequest("artcats/create", fd);}
    public artcatsUpdate(fd: FormData): Observable<IResponse<IArtcat>> {return this.sendRequest("artcats/update", fd);}
    ...
    public awardsChunk(dto: IGetList): Observable<IResponse<IAward[]>> {return this.sendRequest("awards/chunk", dto);}
    public awardsOne(id: number): Observable<IResponse<IAward>> {return this.sendRequest(`awards/one/${id}`);}
    public awardsDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`awards/delete/${id}`);}
    public awardsDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("awards/delete-bulk", ids);}
    public awardsCreate(fd: FormData): Observable<IResponse<IAward>> {return this.sendRequest("awards/create", fd);}
    public awardsUpdate(fd: FormData): Observable<IResponse<IAward>> {return this.sendRequest("awards/update", fd);}
    ...
    public statsInordersMonthly(year: number): Observable<IResponse<number[]>> {return this.sendRequest(`stats/inorders-monthly/${year}`);}
    public statsTotals(): Observable<IResponse<IStatTotals>> {return this.sendRequest(`stats/totals`);}

    public baxersChunk(dto: IGetList): Observable<IResponse<IBaxer[]>> {return this.sendRequest("baxers/chunk", dto);}
    public baxersOne(id: number): Observable<IResponse<IBaxer>> {return this.sendRequest(`baxers/one/${id}`);}
    public baxersDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`baxers/delete/${id}`);}
    public baxersDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("baxers/delete-bulk", ids);}
    public baxersCreate(fd: FormData): Observable<IResponse<IBaxer>> {return this.sendRequest("baxers/create", fd);}
    public baxersUpdate(fd: FormData): Observable<IResponse<IBaxer>> {return this.sendRequest("baxers/update", fd);}

    public commentsChunk(dto: IGetList): Observable<IResponse<IComment[]>> {return this.sendRequest("comments/chunk", dto);}
    public commentsOne(id: number): Observable<IResponse<IComment>> {return this.sendRequest(`comments/one/${id}`);}
    public commentsOneWithUser(id: number): Observable<IResponse<IComment>> {return this.sendRequest(`comments/one-with-user/${id}`);}
    public commentsDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`comments/delete/${id}`);}
    public commentsDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("comments/delete-bulk", ids);}
    public commentsCreate(fd: FormData): Observable<IResponse<IComment>> {return this.sendRequest("comments/create", fd);}
    public commentsUpdate(fd: FormData): Observable<IResponse<IComment>> {return this.sendRequest("comments/update", fd);}

    public shopcatsChunk(dto: IGetList): Observable<IResponse<IShopcat[]>> {return this.sendRequest("shopcats/chunk", dto);}
    public shopcatsOne(id: number): Observable<IResponse<IShopcat>> {return this.sendRequest(`shopcats/one/${id}`);}
    public shopcatsDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`shopcats/delete/${id}`);}
    public shopcatsDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("shopcats/delete-bulk", ids);}
    public shopcatsCreate(fd: FormData): Observable<IResponse<IShopcat>> {return this.sendRequest("shopcats/create", fd);}
    public shopcatsUpdate(fd: FormData): Observable<IResponse<IShopcat>> {return this.sendRequest("shopcats/update", fd);}

    public shopitemsChunk(dto: IGetList): Observable<IResponse<IShopitem[]>> {return this.sendRequest("shopitems/chunk", dto);}
    public shopitemsOne(id: number): Observable<IResponse<IShopitem>> {return this.sendRequest(`shopitems/one/${id}`);}
    public shopitemsDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`shopitems/delete/${id}`);}
    public shopitemsDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("shopitems/delete-bulk", ids);}
    public shopitemsCreate(fd: FormData): Observable<IResponse<IShopitem>> {return this.sendRequest("shopitems/create", fd);}
    public shopitemsUpdate(fd: FormData): Observable<IResponse<IShopitem>> {return this.sendRequest("shopitems/update", fd);}
    public shopitemsArchive(id: number): Observable<IResponse<void>> {return this.sendRequest(`shopitems/archive/${id}`);}
    public shopitemsArchiveBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("shopitems/archive-bulk", ids);}

    public shopordersChunk(dto: IGetList): Observable<IResponse<IShoporder[]>> {return this.sendRequest("shoporders/chunk", dto);}
    public shopordersOne(id: number): Observable<IResponse<IShoporder>> {return this.sendRequest(`shoporders/one/${id}`);}
    public shopordersDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`shoporders/delete/${id}`);}
    public shopordersDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("shoporders/delete-bulk", ids);}
    public shopordersUpdate(fd: FormData): Observable<IResponse<IShoporder>> {return this.sendRequest("shoporders/update", fd);}

    public mailingsChunk(dto: IGetList): Observable<IResponse<IMailing[]>> {return this.sendRequest("mailings/chunk", dto);}
    public mailingsOne(id: number): Observable<IResponse<IMailing>> {return this.sendRequest(`mailings/one/${id}`);}
    public mailingsOneShort(id: number): Observable<IResponse<IMailing>> {return this.sendRequest(`mailings/one-short/${id}`);}
    public mailingsDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`mailings/delete/${id}`);}
    public mailingsDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("mailings/delete-bulk", ids);}
    public mailingsCreate(fd: FormData): Observable<IResponse<IMailing>> {return this.sendRequest("mailings/create", fd);}
    public mailingsUpdate(fd: FormData): Observable<IResponse<IMailing>> {return this.sendRequest("mailings/update", fd);}
    public mailingsRun(id: number): Observable<IResponse<void>> {return this.sendRequest(`mailings/run/${id}`);}

    public dropsChunk(dto: IGetList): Observable<IResponse<IDrop[]>> {return this.sendRequest("drops/chunk", dto);}
    public dropsOne(id: number): Observable<IResponse<IDrop>> {return this.sendRequest(`drops/one/${id}`);}
    public dropsDelete(id: number): Observable<IResponse<void>> {return this.sendRequest(`drops/delete/${id}`);}
    public dropsDeleteBulk(ids: number[]): Observable<IResponse<void>> {return this.sendRequest("drops/delete-bulk", ids);}
    public dropsCreate(fd: FormData): Observable<IResponse<IDrop>> {return this.sendRequest("drops/create", fd);}
    public dropsUpdate(fd: FormData): Observable<IResponse<IDrop>> {return this.sendRequest("drops/update", fd);}
