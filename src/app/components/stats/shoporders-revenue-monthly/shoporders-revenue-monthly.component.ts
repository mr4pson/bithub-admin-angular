...
@Component({
  selector: 'stats-shoporders-revenue-monthly',
  templateUrl: 'shoporders-revenue-monthly.component.html',
  styleUrls: ['../../../styles/graphs.scss'],
})
export class CStatsShopordersRevenueMonthlyComponent implements OnInit {
  ...
  public async initStats(): Promise<void> {
    try {
      ...
      const data = await this.statsRepository.loadShopordersRevenueMonthly({
