...
@Component({
  selector: 'stats-avg-sub-price-monthly',
  templateUrl: 'avg-sub-price-monthly.component.html',
  styleUrls: ['../../../styles/graphs.scss'],
})
export class CStatsAvgSubPriceMonthlyComponent implements OnInit {
  ...
  public async initStats(): Promise<void> {
    try {
      ...
      const data = await this.statsRepository.loadAvgSubPriceMonthly({
