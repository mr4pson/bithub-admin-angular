...
@Component({
  selector: 'stats-subscribers-monthly',
  templateUrl: 'subscribers-monthly.component.html',
  styleUrls: ['../../../styles/graphs.scss'],
})
export class CStatsSubscribersMonthlyComponent implements OnInit {
  ...
  public async initStats(): Promise<void> {
    try {
      ...
      const data = await this.statsRepository.loadSubscribersMonthly({
