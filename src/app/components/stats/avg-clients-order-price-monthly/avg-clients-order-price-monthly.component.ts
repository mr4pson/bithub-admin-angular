...
@Component({
  selector: 'stats-avg-clients-order-price-monthly',
  templateUrl: 'avg-clients-order-price-monthly.component.html',
  styleUrls: ['../../../styles/graphs.scss'],
})
export class CStatsAvgClientsOrderPriceMonthlyComponent implements OnInit {
  ...
  public async initStats(): Promise<void> {
    try {
      ...
      const data = await this.statsRepository.loadAvgClientsOrderPriceMonthly({
