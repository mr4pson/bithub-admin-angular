...
@Component({
  selector: 'stats-subscription-profit-monthly',
  templateUrl: 'subscription-profit-monthly.component.html',
  styleUrls: ['../../../styles/graphs.scss'],
})
export class CStatsSubscriptionProfitMonthlyComponent implements OnInit {
  ...
  public async initStats(): Promise<void> {
    try {
      ...
      const data = await this.statsRepository.loadSubsriptionProfitMonthly({
