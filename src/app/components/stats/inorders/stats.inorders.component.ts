...
@Component({
    selector: "stats-inorders",
    templateUrl: "stats.inorders.component.html",
    styleUrls: ["../../../styles/graphs.scss"],
})
export class CStatsInordersComponent implements OnInit, AfterViewInit {
    ...
    public async initStats(): Promise<void> {
        try {              
            this.data = await this.statsRepository.loadInordersMonthly(this.year);
