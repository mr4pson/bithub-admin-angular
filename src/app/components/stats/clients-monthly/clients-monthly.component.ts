...
@Component({
  selector: 'stats-clients-monthly',
  templateUrl: 'clients-monthly.component.html',
  styleUrls: ['../../../styles/graphs.scss'],
})
export class CStatsClientsMonthlyComponent implements OnInit {
  ...
  public async initStats(): Promise<void> {
    try {
      ...
      const data = await this.statsRepository.loadClientsMonthly({
