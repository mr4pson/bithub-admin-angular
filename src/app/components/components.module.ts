...
import { CStatsMauMonthlyComponent } from './stats/mau-monthly/mau-monthly.component';
import { CStatsSubscribersMonthlyComponent } from './stats/subscribers-monthly/subscribers-monthly.component';
import { CStatsAvgSubPriceMonthlyComponent } from './stats/avg-sub-price-monthly/avg-sub-price-monthly.component';
import { CStatsSubscriptionProfitMonthlyComponent } from './stats/subscription-profit-monthly/subscription-profit-monthly.component';
import { CStatsClientsMonthlyComponent } from './stats/clients-monthly/clients-monthly.component';
import { CStatsAvgClientsOrderPriceMonthlyComponent } from './stats/avg-clients-order-price-monthly/avg-clients-order-price-monthly.component';
import { CStatsShopordersRevenueMonthlyComponent } from './stats/shoporders-revenue-monthly/shoporders-revenue-monthly.component';
import { CStatsShopordersProfitMonthlyComponent } from './stats/shoporders-profit-monthly/shoporders-profit-monthly.component';
...
@NgModule({
  ...
  declarations: [
    ...
    CStatsMauMonthlyComponent,
    CStatsSubscribersMonthlyComponent,
    CStatsAvgSubPriceMonthlyComponent,
    CStatsSubscriptionProfitMonthlyComponent,
    CStatsClientsMonthlyComponent,
    CStatsAvgClientsOrderPriceMonthlyComponent,
    CStatsShopordersRevenueMonthlyComponent,
    CStatsShopordersProfitMonthlyComponent,
    CStatsCatsComponent,
